...
public class Recipe {
    ...
    public static VBox addIngsInput(){
        ...
        for(int i = 0; i < 5; i++){
            ...
            Node inputfield = newIng.getChildren().get(1);
            if((inputfield instanceof TextField)){
                TextField ipf = (TextField)inputfield;
                ipf.setPromptText("Name");
            }
    ...
    public static void createRecipe(){
        ...
        HBox i1 = addInput("Enter name of the recipe", false);
        ...
        HBox i4 = addInput("Enter approximate time of preparation(in mins)", false);
        HBox i5 = addInput("Enter servings", false);
        
        HBox confirmation = addConfirmation();
        Node button1 = confirmation.getChildren().get(0);
        if ((button1 instanceof Button) && ("Okay".equals(((Button)button1).getText()))){
        ...
        Scene addrecipe = new Scene(layout, 600, 800);
    ...
    public static void editRecipe(){
        ...
        layout.setCenter(content);
        Scene editRecipe = new Scene(layout, 400, 400);
    ...
    private static void viewRecipe(String value) {
        Recipe currentRecipe = new Recipe(value);
